...
class BackgroundRemover:
    ...
    def remove_with_grabcut(self, image: np.ndarray, foreground_box: Optional[Tuple] = None) -> np.ndarray:
        ...
        try:
            ...
            if foreground_box:
                ...
                mask[center_y-size:center_y+size, center_x-size:center_x+size] = cv2.GC_PR_FGD
                
                # Set definite foreground (smaller center region)
                inner_size = size // 2
                mask[center_y-inner_size:center_y+inner_size, 
                     center_x-inner_size:center_x+inner_size] = cv2.GC_FGD
    ...
    def apply_mask_with_background(self, image: np.ndarray, mask: np.ndarray, 
    ...
    def remove_background_comprehensive(self, image: np.ndarray, 
                                      method: str = "grabcut",
                                      background_color: Tuple[int, int, int] = (255, 255, 255),
                                      foreground_hint: Optional[Tuple] = None) -> np.ndarray:
