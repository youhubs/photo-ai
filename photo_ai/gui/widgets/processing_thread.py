...
class ProcessingThread(QThread):
    ...
    def __init__(self, processor: PhotoProcessor, input_source: Union[str, List[str]], operation: str):
        super().__init__()
    ...
    def run_visa_processing(self):
        ...
        if not isinstance(self.input_source, str) or not self.input_source.endswith(('.jpg', '.jpeg', '.png', '.bmp')):
