...
class VisaPhotoDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        # Description
        desc = QLabel(
            "Create compliant visa/passport photos with precise dimensions and background removal."
        )
...
• Plain background (will be removed)
    ...
    def select_output_file(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(
            self, "Save Visa Photo As", default_name, "JPEG Files (*.jpg);;All Files (*)"
        )
    ...
    def create_visa_photo(self):
        ...
        self.processing_thread = ProcessingThread(self.processor, self.input_file, "visa")
    ...
    def on_processing_finished(self, results):
        ...
        if results.get("success", False):
            ...
            self.results_text.setText(
                f"❌ Processing failed: {results.get('error', 'Unknown error')}"
            )
    ...
    def on_processing_error(self, error_message: str):
        ...
        QMessageBox.critical(
            self, "Processing Error", f"Visa photo creation failed:\\n\\n{error_message}"
        )
